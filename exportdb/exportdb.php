...
class dbdump extends stdClass {
  ...
  var $tables_en    = array();
  var $tables_dis   = array();
  var $tables_limit = array();
  var $tables_clean = array();
  var $table_from   = '';
  ...
  function __construct($host = '', $user = '', $pass = '', $name = '', $dir = 'media', $ins_length = 100) {
    $this->host = $host;
    $this->user = $user;
    $this->pass = $pass;
    $this->name = $name;
  ...
  function file_chmod ( $path = '.', $permission = 0777 ) {
