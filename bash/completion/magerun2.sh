...
_magerun2()
{
    ...
    if [[ ${cur} == --* ]] ; then
        ...
        case "$com" in
            ...
            ;;
            catalog:group-product:visibility)
            opts="${opts} "
            ;;
