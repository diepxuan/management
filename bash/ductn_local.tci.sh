...
#
#########################################
cat /var/www/base/httpd/httpd.conf | ssh local.tci "sudo tee /etc/apache2/sites-available/local.conf"
cat /var/www/base/httpd/local/httpd.conf | ssh local.tci "sudo tee -a /etc/apache2/sites-available/local.conf"
