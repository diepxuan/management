...
curl -fsSL https://download.opensuse.org/repositories/openSUSE:/Tools/Debian_$CODENAME/Release.key | sudo gpg --dearmor -o /etc/apt/trusted.gpg.d/opensuse_$CODENAME.gpg
